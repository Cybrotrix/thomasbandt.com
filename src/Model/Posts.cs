        ...
        static Posts()
        {
            _posts = new []
            {
                ...
                new Post
                {
                    ...
                    Abstract = "I am looking for our seventh team member who will work with us on a large cross-platform app for both iOS and Android. Location: Munich,  working 100% remote is possible. Interested? Read on.",
