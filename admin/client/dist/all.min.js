...
!function(){"use strict";function AddPostController($scope){$scope.published=!0,$scope.submitted=!1,$scope.submit=function($event){return $scope.submitted=!0,$scope.form.$invalid?void $event.preventDefault():void $scope.form.submit()}}angular.module("admin").controller("AddPostController",AddPostController),AddPostController.$inject=["$scope"]}();